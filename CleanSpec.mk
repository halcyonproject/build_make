...
# Clean up Nest which has been replaced with NestQuickStep
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/app/Nest)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system/priv-app/Nest)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/common/obj/APPS/Nest_intermediates)
